...
<body class="bg-gray-100">
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg border-t-4 border-blue-500 h-fit">
        ...
        <div class="space-y-4">
            ...
            <form action="/run-ansible-backup" method="POST">
                @csrf
    ...
    <!-- KOLOM KANAN: Table Managed Switch (Mengambil 2 kolom sisa) -->
    <div class="lg:col-span-2 bg-white p-6 rounded-xl shadow-lg border-t-4 border-gray-500">
        <h2 class="text-xl font-bold text-gray-800 mb-6 flex items-center">
            <span class="mr-2">🖥️</span> Managed Switches
        </h2>
        <div class="overflow-x-auto">
            <table class="min-w-full table-auto">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-4 py-2 text-left text-xs font-medium text-gray-500 uppercase">Device Name</th>
