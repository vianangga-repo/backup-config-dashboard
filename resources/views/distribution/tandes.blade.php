                    ...
                    @forelse($files as $file)
                        <tr class="hover:bg-gray-50/60 transition-colors">
                            ...
                            <td class="py-4 px-6 text-center whitespace-nowrap">
                                <a href="{{ route('distri.tandes.download', ['filename' => $file['name']]) }}" class="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-1.5 px-4 rounded-lg text-xs transition-all shadow-xs">
                                    Download
                                </a>
                            </td>
                        </tr>
